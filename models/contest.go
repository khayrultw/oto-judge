...
type Contest struct {
	...
	StartTime CustomTime `json:"start_time" validate:"required" binding:"required"` // Start time of the contest
	Duration  int        `json:"duration" validate:"required" binding:"required"`   // Duration in minutes
